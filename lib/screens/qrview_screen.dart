...
class _QRScanPageState extends State<QRScanPage> {
                  ...
                  child: IconButton(
                    onPressed: () async {
                      ...
                      if (image != null) {
                        ...
                        resultPath =
                            await RScan.scanImagePath(pathFile.toString());
                        setState(() {});
                      }
                    },
                    icon: FutureBuilder(
                  ...
                  if (result != null)
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        addQrResult(
                          resultPath!.message.toString(),
                          resultPath!.message!.startsWith('http://') ||
                                  resultPath!.message!.startsWith('https://') ||
                                  resultPath!.message!.startsWith('www.')
                              ? 'Website'
  ...
  Future addQrResult(String data, String type, int id) async {
    final qrResult = QrResult(
      data: data,
      createTime: DateTime.now(),
      type: type,
    );
    await QrResultDatabase.instance.create(qrResult);
  }
}
